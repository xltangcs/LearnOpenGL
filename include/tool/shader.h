...
public:
    ...
    Shader(const char *vertexPath, const char *fragmentPath, const char *geometryPath = nullptr)
    {
        ...
        //../src/ 26_Geometry_Shader /shader/vertex.glsl
        vert_string.insert(0, dirName);
        frag_string.insert(0, dirName);
        ...
        if (geometryPath != nullptr)
        {
            ...
            gemo_char = gemo_string.insert(0, dirName).c_str();
            // std::cout<<gemo_string<<"\n";
        }
